...
SUBMIT = (By.CSS_SELECTOR, 'button.btn-apply.js-submit.app-apply-button.application-form__submit-button.ax-btn')


@Given('Open AX application form')
def open_page(context):
    context.driver.get("https://staging-with-es.herokuapp.com/test_account/apply/private-funnel?preview=true")
